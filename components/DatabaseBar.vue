<template>
  <div class="flex flex-row space-x-3 sm:space-x-6">
    <img class="h-10 sm:h-12" src="~/assets/logo/db-mysql.png" alt="mysql" />
    <img
      class="h-10 sm:h-12"
    ...
    <img
      ...
      alt="clickhouse"
    />
    <img class="h-10 sm:h-12" src="~/assets/logo/db-tidb.png" alt="tidb" />
    <img
      class="h-10 sm:h-12"

<template>
  <div class="flex flex-row space-x-6">
    <img class="h-14" src="~/assets/logo/db-mysql.png" alt="mysql" />
    <img class="h-14" src="~/assets/logo/db-postgres.png" alt="postgresql" />
    <img class="h-14" src="~/assets/logo/db-clickhouse.png" alt="clickhouse" />

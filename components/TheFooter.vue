  ...
  <footer class="bg-white pb-8" aria-labelledby="footer-heading">
    ...
    <div class="max-w-7xl mx-auto pt-12 pb-8 px-4 sm:px-6 lg:pt-16 lg:px-8">
      <div class="grid grid-cols-2 lg:grid-cols-5 lg:gap-8">
        ...
        <div class>
          <h3 class="text-sm font-semibold text-gray-400 tracking-wider uppercase">Databases</h3>
          <ul class="mt-4 space-y-4">
            <li>
              <NuxtLink
                to="/database/mysql"
            ...
            <li>
              <NuxtLink to="/database/tidb" class="text-base text-gray-500 hover:text-gray-900">TiDB</NuxtLink>
            </li>
            <li>
              <NuxtLink
        ...
        <div class="mt-12 lg:mt-0">
          <h3 class="text-sm font-semibold text-gray-400 tracking-wider uppercase">Integrations</h3>
          <ul class="mt-4 space-y-4">
            <li>
              <NuxtLink
        ...
        <div class="mt-12 lg:mt-0">
          ...
          <ul class="mt-4 space-y-4">
            ...
            <li>
              <a
                href="https://star-history.com/#bytebase/bytebase"
                target="__blank"
                class="flex flex-row space-x-2 items-center text-base text-gray-500 hover:text-gray-900"
              >

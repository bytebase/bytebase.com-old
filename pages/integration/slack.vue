  ...
  <div class="lg:grid lg:grid-cols-12 lg:gap-8">
    ...
    >
      <h1>
        ...
        >
          <span class="block text-gray-900">Slack + Bytebase</span>
        </span>
      </h1>
      <h2
      ...
      >
        ...
        configured Slack channel. Those webhook events are specifically
        customized for Slack in order to display the optimal format.
      </h2>
      <div
    ...
    >
      <div class="relative mx-auto w-full rounded-lg lg:max-w-md">
        <img class="w-full" src="~/assets/bytebase_and_slack.webp" alt="" />
      </div>
    </div>
  </div>
</template>

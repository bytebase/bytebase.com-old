  ...
  <div class="lg:grid lg:grid-cols-12 lg:gap-8">
    ...
    >
      <h1>
        ...
        >
          <span class="block text-gray-900">DingTalk (钉钉) + Bytebase</span>
        </span>
      </h1>
      <h2
      ...
      >
        ...
        configured DingTalk group. Those webhook events are specifically
        customized for DingTalk in order to display the optimal format.
      </h2>
      <div
    ...
    >
      <div class="relative mx-auto w-full rounded-lg lg:max-w-md">
        <img class="w-full" src="~/assets/bytebase_and_dingtalk.webp" alt="" />
      </div>
    </div>
  </div>
</template>

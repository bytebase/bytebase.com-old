<template>
  <div>
              ...
              <div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                <div class="-mt-6">
                  ...
                  <p class="mt-5 text-base text-gray-500">
                    Classic workflow where developer submits a SQL review ticket
                    for DBA to review.
                  </p>
                </div>
              </div>
            ...
            <div class="pt-6">
              <div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                <div class="-mt-6">
                  ...
                  <p class="mt-5 text-base text-gray-500">
                    Support multi-stage, multi-environment schema change in a
                    single pipeline.
                  </p>
                </div>
              </div>
            ...
            <div class="pt-6">
              <div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                <div class="-mt-6">
                  ...
                  <p class="mt-5 text-base text-gray-500">
                    Zero-config, dependency free, operational friendly, deploy
                    in 5 seconds.
                  </p>
                </div>
              </div>
    ...
    <div class="flex py-8 rounded-md justify-center shadow">
      <a
        href="https://github.com/bytebase/bytebase#installation"
        target="_blank"
        @click="track('deploy.footer')"

              ...
              <div class="flex flex-col items-center">
                ...
                <button
                  :class="[
                    ...
                    'mt-6 w-full inline-block py-4 rounded-md shadow-sm text-center text-sm lg:text-xl font-medium'
                  ]"
            ...
            <button
              :class="[
                plan.featured
                  ? 'bg-indigo-600 text-white hover:bg-indigo-700 border border-transparent'
                  : 'ring-2 ring-indigo-600',
                'mt-6 w-full inline-block py-2 rounded-md shadow-sm text-center text-sm font-medium'
              ]"
              @click="onButtonClick(plan)"
            >{{ plan.buttonText }}</button>
          </div>
              ...
              <button
                :class="[
                  plan.featured
                    ? 'bg-indigo-600 text-white hover:bg-indigo-700 border border-transparent'
                    : 'ring-2 ring-indigo-600',
                  'mt-6 w-full inline-block py-4 rounded-md shadow-sm text-center text-sm font-medium'
                ]"
                @click="onButtonClick(plan)"
              >{{ plan.buttonText }}</button>
            </div>

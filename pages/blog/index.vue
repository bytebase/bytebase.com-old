  ...
  <div class="relative bg-white px-4 sm:px-6 lg:px-8 py-8">
    <div class="relative max-w-7xl mx-auto">
      <div class="text-center">
        <h1 class="text-3xl tracking-tight font-extrabold text-gray-900 sm:text-5xl">Bytebase Blog</h1>
      ...
      <div class="py-12">
        <div class="relative max-w-lg mx-auto lg:max-w-7xl">
          <div class="text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl">Featured</div>
          <div class="mt-12 space-y-6">
            ...
            >
              ...
              >
                <div class="flex-1">
                  <div v-for="(tag, tagIndex) in post.tags" :key="tagIndex" class="inline-flex">
                    <span
                ...
                <div class="mt-6 flex items-center">
                  <div class="flex-shrink-0">
                    <img class="h-10 w-10 rounded-full" :src="post.authors[0].profile_image" alt />
                  </div>
                  <div class="ml-3">
                    <p class="text-sm font-medium text-gray-900">{{ post.authors[0].name }}</p>
...
export default {
  ...
  async asyncData() {
    const posts = (await getPosts(["Announcement", "Education"])) as PostsOrPages;

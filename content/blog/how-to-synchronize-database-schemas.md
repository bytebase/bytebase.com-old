...
From Bytebase [1.8.0](/changelog/bytebase-1-8-0), you can run a 14-day **Pro Plan** trial without hub registration. While having **Pro Plan** trial, you can upgrade to the **Enterprise Plan** trial by clicking **Upgrade** in a specific feature.
![dbprod t1](/static/blog/how-to-synchronize-database-schemas/dbprod-t1.webp)

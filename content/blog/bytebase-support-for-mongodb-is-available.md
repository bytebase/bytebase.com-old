...
As the ranking by DBMS’s current popularity from [DB-Engines](https://db-engines.com/en/ranking) shown, until Jan 2023, MongoDB is the only NoSQL database in the top 5 of the overall DB-Engines ranking.

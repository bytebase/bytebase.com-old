---
title: Database Change Management using Bytebase SaaS
author: Ningjing
published_at: 2023/04/17 16:15
feature_image: /static/blog/database-change-management-using-bytebase-saas/feature-image.webp
tags: Tutorial
integrations: MySQL
level: Beginner
description: Bytebase provide its SaaS version since 1.15.0, This tutorial is a step-by-step guide to set up Database Change Management for Amazon Aurora MySQL using Bytebase SaaS. 
---
...
- Database Change Management using Bytebase SaaS (this one)
- [Database Change Management with GitHub using Bytebase SaaS](/blog/database-change-management-with-github-using-bytebase-saas)

---

Bytebase is an open-source database CI/CD tool for developers and DBAs. It provides its SaaS version since [1.15.0](/changelog/bytebase-1-15-0). You can still use its [self-hosted version](/docs/get-started/install/deploy-with-docker).
...
This tutorial is a step-by-step guide to set up Database Change Management for **Amazon Aurora MySQL** using **Bytebase SaaS**. With Bytebase, a team can have a formalized review and rollout process to make Amazon Aurora database schema change and data change.
...
4. After its provision, the workspace is ready. You'll receive an email with the password. Click **Login to your workspace**, and you'll be redirected to the Bytebase SaaS login page.
![email-workspace-ready](/static/blog/database-change-management-using-bytebase-saas/email-workspace-ready.webp)
![bb-login](/static/blog/database-change-management-using-bytebase-saas/bb-login.webp)
...
![aws-security-groups](/static/blog/database-change-management-using-bytebase-saas/aws-security-groups.webp)
...
![aws-inbound-rules](/static/blog/database-change-management-using-bytebase-saas/aws-inbound-rules.webp)
![aws-edit-inbound-rules](/static/blog/database-change-management-using-bytebase-saas/aws-edit-inbound-rules.webp)

3. Go to Bytebase SaaS console, and click **Add Instance**.
![bb-home-add-instance](/static/blog/database-change-management-using-bytebase-saas/bb-home-add-instance.webp)
...
![bb-create-instance](/static/blog/database-change-management-using-bytebase-saas/bb-create-instance.webp)
...
![bb-projects-new-project](/static/blog/database-change-management-using-bytebase-saas/bb-projects-new-project.webp)
...
![bb-issue-create-dbdemo](/static/blog/database-change-management-using-bytebase-saas/bb-issue-create-dbdemo.webp)
...
![bb-alter-schema-select-db](/static/blog/database-change-management-using-bytebase-saas/bb-alter-schema-select-db.webp)
...
![bb-schema-editor](/static/blog/database-change-management-using-bytebase-saas/bb-schema-editor.webp)
...
![bb-issue-create-t1](/static/blog/database-change-management-using-bytebase-saas/bb-issue-create-t1.webp)
...
![bb-issue-t1-done](/static/blog/database-change-management-using-bytebase-saas/bb-issue-t1-done.webp)

7. From the issue page, click **View change**, and you can see schema diff.
![bb-change-diff-t1](/static/blog/database-change-management-using-bytebase-saas/bb-change-diff-t1.webp)
...
![bb-issue-insert-data-done](/static/blog/database-change-management-using-bytebase-saas/bb-issue-insert-data-done.webp)

5. Click **SQL Editor** on the left side bar. Input the query and click **Run**. You can see the new row is there.
![bb-sql-editor-select-1](/static/blog/database-change-management-using-bytebase-saas/bb-sql-editor-select-1.webp)
...
![bb-issue-before-rollback](/static/blog/database-change-management-using-bytebase-saas/bb-issue-before-rollback.webp)

2. It may fail if the instance hasn't set `binlog_format = ROW`.
![bb-issue-rollback-fail](/static/blog/database-change-management-using-bytebase-saas/bb-issue-rollback-fail.webp)

3. Go to Amazon RDS, click **Parameter groups** to create a new parameter group and set **binlog_format** to `ROW`.
![aws-create-param](/static/blog/database-change-management-using-bytebase-saas/aws-create-param.webp)
![aws-param-row](/static/blog/database-change-management-using-bytebase-saas/aws-param-row.webp)

4. Apply the parameter group to your database instance.
![aws-apply-param-group-bb](/static/blog/database-change-management-using-bytebase-saas/aws-apply-param-group-bb.webp)

5. Go back to Bytebase **SQL Editor**, and switch to **Admin Mode**.
![bb-sql-editor-admin](/static/blog/database-change-management-using-bytebase-saas/bb-sql-editor-admin.webp)
...
```
![bb-sql-editor-admin-show-config](/static/blog/database-change-management-using-bytebase-saas/bb-sql-editor-admin-show-config.webp)

8. Reboot the Aurora MySQL instance.
![aws-reboot](/static/blog/database-change-management-using-bytebase-saas/aws-reboot.webp)

9. Repeat the Step 6, but this time, we can see the **Preview rollback issue**. Click it and then click **Create** on the issue page.
![bb-issue-before-rollback-preview](/static/blog/database-change-management-using-bytebase-saas/bb-issue-before-rollback-preview.webp)
![bb-issue-rollback-preview](/static/blog/database-change-management-using-bytebase-saas/bb-issue-rollback-preview.webp)

10. Rollback always requires explicit approval.
![bb-issue-rollback-to-approve](/static/blog/database-change-management-using-bytebase-saas/bb-issue-rollback-to-approve.webp)

11. Before approving rollback, let's go to **SQL Editor** and query. `Bella` is there.
![bb-sql-editor-query-2](/blog/database-change-management-using-bytebase-saas/bb-sql-editor-query-2.webp)

12. Go back to the issue page and click **Approve**. The rollback SQL will execute.
![bb-issue-rollback-executed](/static/blog/database-change-management-using-bytebase-saas/bb-issue-rollback-executed.webp)
...
![bb-sql-editor-query-3](/static/blog/database-change-management-using-bytebase-saas/bb-sql-editor-query-3.webp)
...
WHERE
  table_name = 't1';
```
![bb-sql-editor-admin-age](/static/blog/database-change-management-using-bytebase-saas/bb-sql-editor-admin-age.webp)
...
![bb-ac-schema-drift](/static/blog/database-change-management-using-bytebase-saas/bb-ac-schema-drift.webp)

5. Click on **View diff**, you will see the exact drift.
![bb-drift-age](/static/blog/database-change-management-using-bytebase-saas/bb-drift-age.webp)

6. You may also find the drift by clicking **Databases** > **db_demo**.
![bb-dbdemo-drift](/static/blog/database-change-management-using-bytebase-saas/bb-dbdemo-drift.webp)
...
![bb-dbdemo-new-baseline](/static/blog/database-change-management-using-bytebase-saas/bb-dbdemo-new-baseline.webp)
